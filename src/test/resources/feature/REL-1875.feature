@ST_13216 @tagtagtag @this_is_story_tag @new_changes
...
@SC_55621 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_55622 @third_scenario_tag
...
@SC_55623 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_55624 @fifth_scenario_tag
