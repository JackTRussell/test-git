@ST_26435 @tagtagtag @this_is_story_tag
...
@SC_106835 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_106836 @third_scenario_tag
...
@SC_106837 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_106838 @fifth_scenario_tag
